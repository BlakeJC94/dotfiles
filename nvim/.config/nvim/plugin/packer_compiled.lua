...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-toggleterm.lua', 'nvim-bufferline.lua', 'nvim-dap-ui', 'dashboard-nvim', 'nvim-dap'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
